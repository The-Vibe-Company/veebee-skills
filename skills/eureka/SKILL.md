...
Two safeguards. The user can say "stop" or "ça suffit" at any time: write what you have and finish. And after ten turns, show the page as it stands and ask whether to continue or finish there.
...
When no question would change a slot, stop asking and show the whole Idea on the canvas in its readable form: short sections with a heading each, one or two sentences per section. Then ask one thing: does the page say it right? Two options, yes or "I would change something", the second one open.
